...
=item Latest source code from CVS
...
L<http://sourceforge.net/cvs/?group_id=135105>
...
=item *
wxWindows 2.6.0 or 2.4.2 

=back

If you downloaded the latest CVS, you will need to run this first:

	./autogen.sh

Otherwise, just extract the contents of the archive, and change into
the directory it creates (e.g. boxi-0.1.0).
