...
L<http://www.qwirx.com/boxi/boxi-0.1.0.tar.gz>
...
You can get the latest CVS source code (experimental, not guaranteed
to compile or run on any system, YYMV) from Sourceforge:
...
=item Version 0.1.0 (released 2005-05-25)

L<http://prdownloads.sourceforge.net/boxi/boxi-0.1.0.tar.gz>
